#include "Menu.h"
    ...
    char arena[15][30]={
                     ...
                     "HC_H__________hCB__h________hH",
                     "HC_C__H_______H__hh_____H___hH",
                     "Hh____h_______hhC___________hH",
                     "Hh____H___H___C__h___H______CH",
                     "Hh_______H___h__________H___hH",
                     "Hh____H__H____H___H_________hH",
                     "Hh__________H_H_____H____h__hH",
                     "Hh_H__C__H____Ch___H___H____CH",
                     "Hh___H__H___hHh____H________hH",
                     "HhCChChhhhhCChH_h_______H___hH",
